...
class TestDataEdit(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.db5 = pd.DataFrame(np.arange(4).reshape(2,2),columns=('a','b'))
    ...
    def setUp(self):
        ...
        self.data4 = self.db4
        self.data5 = daf.DataEdit(self.db5)
    ...
    def test_column_type(self):
        self.assertIsInstance(self.data5.columntype('a'),np.dtype, 'Is not a numpy dtype')
